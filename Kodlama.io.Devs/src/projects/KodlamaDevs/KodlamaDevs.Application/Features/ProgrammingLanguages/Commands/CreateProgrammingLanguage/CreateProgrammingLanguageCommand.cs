...
namespace KodlamaDevs.Application.Features.ProgrammingLanguages.Commands.CreateProgrammingLanguage
{
    public class CreateProgrammingLanguageCommand : IRequest<CreatedProgrammingLanguageDto>
    {
        ...
        public class CreateProgrammingLanguageHandler : IRequestHandler<CreateProgrammingLanguageCommand, CreatedProgrammingLanguageDto>
        {
            ...
            public CreateProgrammingLanguageHandler(IProgrammingLanguageRepository programmingLanguageRepository, IMapper mapper = null, ProgrammingLanguageRules programmingLanguageBusinessRules = null)
            {
            ...
            {
                await _programmingLanguageBusinessRules.ProgrammingLanguageCanNotBeDublicateWhenInserted(request.Name);
